...
mkdir -p experiments/logs/test_rcnn_caffenet_ho_pconv_ip1_p/

LOG="experiments/logs/test_rcnn_caffenet_ho_pconv_ip1_p/36_baseball_glove.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
