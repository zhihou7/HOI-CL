...
LOG="experiments/logs/fast_rcnn_caffenet_ho_pconv_ip1_s.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./fast-rcnn/tools/test_net.py --gpu $gpu_id \
  ...
  --net ./output/ho_1_s/hico_det_train2015/fast_rcnn_caffenet_pconv_ip_iter_150000.caffemodel \
