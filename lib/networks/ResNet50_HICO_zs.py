...
class ResNet50():
    def __init__(self, model_name):
        ...
        zero_shot_type = get_zero_shot_type('_zs7_')
        ...
        num_inst_path = cfg.LOCAL_DATA +  '/Data/num_inst.npy'
        num_inst = np.load(num_inst_path)
        self.num_inst = num_inst
        self.num_inst_all = np.load(cfg.LOCAL_DATA + '/Data/num_inst_new.npy')
        ...
        self.obj_to_HO_matrix = tf.matmul(self.obj_to_HO_matrix, self.zs_convert_matrix)
        self.verb_to_HO_matrix = tf.matmul(self.verb_to_HO_matrix, self.zs_convert_matrix)
        ...
        #
        # from networks.generate_objects import get_word2vec, get_verb_word2vec
